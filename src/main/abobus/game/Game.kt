...
class Game: Game() {
    ...
    override fun create() {
        textures.put(Constants.PLAYER, Texture("src/main/resources/icons/entity/tank.png"))
        textures.put(Constants.ENEMY, Texture("src/main/resources/icons/entity/amogus2.png"))

        textures.put(Constants.WALL, Texture("src/main/resources/icons/blocks/wall.png"))
        textures.put(Constants.WATER, Texture("src/main/resources/icons/blocks/water.jpg"))
        textures.put(Constants.MOR, Texture("src/main/resources/icons/blocks/morshrum.jpg"))
        textures.put(Constants.FLOW, Texture("src/main/resources/icons/blocks/flower.jpg"))
        textures.put(Constants.TREE, Texture("src/main/resources/icons/blocks/tree.jpg"))
    ...
    fun onContact(num: Int){
        hpBar = Texture("src/main/resources/icons/hp_bar/hp_bar${num}.jpg")
    }
    private fun update(){
