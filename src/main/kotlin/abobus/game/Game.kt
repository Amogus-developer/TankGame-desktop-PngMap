...
class Game: Game() {
    ...
    private fun loadMap(path: String){
        ...
        createMap(ImageIO.read(File(path)), 5F, 5F).forEach {
            when(it.color) {
                Constance.PLAYER -> player = Entity(p, world.createCircle(it.x, it.y))
    ...
    override fun create() {
        textures.put(Constance.PLAYER, Texture("src/main/resources/icons/tank.png"))
        textures.put(Constance.ENEMY, Texture("src/main/resources/icons/amogus2.png"))
        textures.put(Constance.WALL, Texture("src/main/resources/icons/wall.png"))

        textures.put(Constance.WATER, Texture("src/main/resources/icons/water.jpg"))
        textures.put(Constance.MOR, Texture("src/main/resources/icons/morshrum.jpg"))
        textures.put(Constance.FLOW, Texture("src/main/resources/icons/flower.jpg"))
        textures.put(Constance.TREE, Texture("src/main/resources/icons/tree.jpg"))
